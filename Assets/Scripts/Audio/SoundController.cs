...
public class SoundController : MonoBehaviour
{
    ...
    void Update()
    {
        float carSpeed = transform.GetComponent<Rigidbody>().velocity.magnitude;
        float carSpeedFactor = Mathf.Clamp01(carSpeed / 180);
        ...
        pitchFactor *= 0.3f;
        pitchFactor += throttleFactor * (0.7f) * Mathf.Clamp01(car.throttle * 2.0f);
