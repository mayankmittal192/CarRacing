...
/// <summary>
// Attach this to a GUIText to make a frames/second indicator. It calculates frames/second over each updateInterval, 
// so the display does not keep changing wildly. It is also fairly accurate at very low FPS counts (<10). We do this 
// not by simply counting frames per interval, but by accumulating FPS for each frame. This way we end up with correct 
// overall FPS even if the interval renders something like 5.5 frames.
/// </summary>
