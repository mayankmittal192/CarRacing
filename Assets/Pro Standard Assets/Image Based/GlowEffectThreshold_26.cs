...
public class GlowEffectThreshold_26 : MonoBehaviour
{
    ...
    private static Shader compositeMatShader;
    ...
    protected static Material compositeMaterial
    {
        get
        {
            ...
            {
                compositeMatShader = Shader.Find("GlowCompose");
                m_CompositeMaterial = new Material(compositeMatShader);
    ...
    private static Shader blurMatShader;
    ...
    protected static Material blurMaterial
    {
        get
        {
            ...
            {
                blurMatShader = Shader.Find("BlurConeTap");
                m_BlurMaterial = new Material(blurMatShader);
    ...
    protected void OnDisable()
    {
        ...
        if (m_BlurMaterial)
        {
            DestroyImmediate(m_BlurMaterial.shader, true);
            DestroyImmediate(m_BlurMaterial, true);
        }
        if (m_DownsampleMaterial)
            DestroyImmediate(m_DownsampleMaterial, true);
    }
