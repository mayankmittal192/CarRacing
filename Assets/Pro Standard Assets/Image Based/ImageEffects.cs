...
public class ImageEffects
{
    ...
    static public Material GetBlitMaterial(BlendMode mode)
    {
        ...
        // Blit Copy Material
        shader = Shader.Find("BlitCopy");
        m_BlitMaterials[0] = new Material(shader);

        // Blit Multiply
        shader = Shader.Find("BlitMultiply");
        m_BlitMaterials[1] = new Material(shader);

        // Blit Multiply 2X
        shader = Shader.Find("BlitMultiplyDouble");
        m_BlitMaterials[2] = new Material(shader);

        // Blit Add
        shader = Shader.Find("BlitAdd");
        m_BlitMaterials[3] = new Material(shader);

        // Blit AddSmooth
        shader = Shader.Find("BlitAddSmooth");
        m_BlitMaterials[4] = new Material(shader);

        // Blit Blend
        shader = Shader.Find("BlitBlend");
        m_BlitMaterials[5] = new Material(shader);
